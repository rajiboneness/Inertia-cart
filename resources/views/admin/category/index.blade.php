            ...
            <div class="card">
                <div class="card-body">
                    ...
                    @csrf
                        ...
                        <div class="form-group mb-3">
                            <label class="label-control">Collections <span class="text-danger">*</span> </label>
                            <select class="form-control" name="call_id">
                                <option hidden selected>Select collections...</option>
                                @foreach ($collectios as $index => $item)

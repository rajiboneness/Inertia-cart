...
@section('content')
<section>
<div class="text-end py-3"><a href="{{ route('admin.subcategory.index') }}" class="btn btn-success">back</a></div>
    <div class="row">
        <div class="col-sm-8">
            <div class="card">    
                <div class="card-body">
                ...
                <div class="card-body">
                    ...
                    @csrf
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-sm btn-danger">Update Sub Category</button>
                        </div>
                    </form>
                </div>
            </div>

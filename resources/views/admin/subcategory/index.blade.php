        ...
        <div class="col-sm-4">
            <div class="card">
                <div class="card-body">
                    ...
                    @csrf
                        <h4 class="page__subtitle">Add New SubCategory</h4>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select class="form-control" name="cat_id">
                                <option hidden selected>Select Categories</option>
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-sm btn-danger">Add New SubCategory</button>
                        </div>
                    </form>
                </div>
            </div>

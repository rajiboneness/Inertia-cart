                        ...
                        <div class="col-md-12">
                            <div class="d-flex">
                                @if($data->userId->image)
                                    <img src="{{asset($data->userId->image)}}" alt="" style="height: 100px" class="mr-4">
                                @else
                                    <img src="{{asset('admin/images/placeholder-image.jpg')}}" alt="" class="me-4" style="width: 65px;height: 65px;border-radius: 50%;">
                                @endif
                                <div>
                                    <h5>{{$data->userId->fname.' '.$data->userId->lname}}</h5>
                                    <p class="text-muted small mb-0 mt-2">{{$data->userId->email}}</p>
                                    <p class="text-muted small">{{$data->userId->mobile}}</p>
                                </div>
                            </div>
                    ...
                    @csrf
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select class="form-control" name="type">
                                <option value="{{ $data->type }}" hidden selected>
                                @php 
                                if($data->type == 1){
                                    echo 'Home';
                                }elseif($data->type == 2){
